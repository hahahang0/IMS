     ...
     <div class=" mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
         ...
         <div class="hidden items-center gap-8 md:flex">
             ...
             <div class="group relative">
                 ...
                 <a href="#features"
                     class='flex items-center gap-1 text-sm font-medium text-slate-600 transition  hover:text-blue-600'>
                     Features
                     <svg class="h-4 w-4 transition-transform duration-150 group-hover:rotate-180" viewBox="0 0 24 24"
                 ...
                 <div
                     class="invisible absolute left-0 top-full z-20 w-56 translate-y-1 rounded-lg border border-secondary-100 bg-white opacity-0 shadow-lg transition-all duration-150 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100">
                     <div class="p-2">
                         <a href="#"
                             class="block rounded-md px-3 py-2 text-sm text-secondary-600 hover:bg-secondary-50 hover:text-primary-600">Feature
                             1</a>
                         <a href="#"
                             class="block rounded-md px-3 py-2 text-sm text-secondary-600 hover:bg-secondary-50 hover:text-primary-600">Feature
                             2</a>
